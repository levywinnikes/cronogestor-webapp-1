...
import { Loader2, ArrowLeft, LogOut, Plus, Building2, Save } from "lucide-react";
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
         <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                {isLoading ? <Loader2 className="animate-spin h-4 w-4 mr-2" /> : <Save className="w-4 h-4 mr-2" />}
                Salvar Projeto
              </button>
            </div>
         </div>
      ...
      <main className="flex-1 max-w-[1000px] w-full mx-auto p-4 sm:p-6 lg:p-8 flex flex-col gap-6">
        ...
        <form id="project-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-200">
            <h3 className="text-sm font-bold text-gray-800 mb-6 pb-2 border-b border-gray-100">Informações Básicas</h3>
            ...
            <div className="flex gap-8 mb-6">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-sm font-semibold text-gray-700">Cadastro completo</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input 
                  type="radio" 
                  ...
                  className="w-4 h-4 text-[#002f5c] bg-gray-100 border-gray-300 focus:ring-[#002f5c]"
                />
                <span className="ml-2 text-sm font-semibold text-gray-700">Cadastro simples</span>
              </label>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Responsável</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Tipo de contrato</label>
                  <select
                    className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-[#002f5c]/20 outline-none transition"
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Contratante</label>
                  <input
                    type="text"
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-200">
            <h3 className="text-sm font-bold text-gray-800 mb-6 pb-2 border-b border-gray-100">Planejamento e Custos</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                     <div>
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Início <span className="text-red-500">*</span></label>
                        <input
                          type="date"
                     ...
                     <div>
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Término <span className="text-red-500">*</span></label>
                        <input
                           type="date"
                           className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white transition"
                           {...register("endDate")}
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Nº do contrato</label>
                    <input
                      type="text"
                      className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white transition"
               ...
               <div className="space-y-6">
                 <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Status <span className="text-red-500">*</span></label>
                    <select
                      className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white transition"
                      {...register("status")}
                    >
                 ...
                 <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Custo Previsto da Obra (Opcional)</label>
                    <input
                      type="text"
                      placeholder="R$ 0,00"
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex items-center">
              <label className="flex items-center cursor-pointer group">
                  ...
                  />
                  <span className="ml-3 text-sm font-bold text-gray-700 group-hover:text-gray-900">Ativar Gestão de Tarefas para este Projeto</span>
               </label>
            </div>
          </div>
